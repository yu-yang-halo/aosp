...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Subject_t, stringdata) + ofs \
...
const QMetaObject Subject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Subject.data,
      qt_meta_data_Subject,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Subject.stringdata))
        return static_cast<void*>(const_cast< Subject*>(this));
